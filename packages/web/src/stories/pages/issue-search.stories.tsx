...
const ResultRow = ({ title, summary, time, stage, needsYou = false, tags, index = 0, baseDelay = 0 }: ResultRowProps): React.ReactElement => {
  const Icon = stageIcon[stage]
  return (
    <motion.div {...stagger(index, baseDelay)} className="group flex items-start gap-3 py-3.5 -mx-2 px-2 rounded-lg cursor-pointer hover:bg-white/3 transition-colors border-b border-white/4 last:border-0">
