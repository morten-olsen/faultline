...
import { ArrowRight, ExternalLink, MoreHorizontal, Hand } from 'lucide-react'
  ...
  render: () => (
    <div className="max-w-xl flex flex-col gap-4">
      <p className="text-text-secondary text-sm leading-relaxed mb-4 max-w-lg">
        Cards are the primary container. The variant communicates the nature of the
        content — most cards are default or issue; "needs you" is reserved for items
      ...
      <Card>
        ...
        <CardBody>
          The standard container. Resolved lists, informational sections.
        </CardBody>
      </Card>
      ...
      <Card variant="issue" interactive>
        ...
        <CardBody>
          An active issue in the pipeline. Interactive — hover reveals the ring brightening.
        </CardBody>
        <CardFooter>
      ...
      <Card variant="needs-you">
        ...
        <CardBody>
          Amber tint — a colleague asking for help, not an alarm. The pipeline is
          paused until the user acts.
        </CardBody>
        <CardCallout>
          This is a callout — it explains exactly what the user needs to do.
        </CardCallout>
        <CardFooter>
      ...
      <Card variant="subtle">
        <CardBody>
          Subtle variant — minimal styling for nested or secondary content.
        </CardBody>
      </Card>
    </div>
  ),
...
const ComposedIssue: Story = {
  render: () => (
    <div className="max-w-xl flex flex-col gap-4">
      <p className="text-text-secondary text-sm leading-relaxed mb-4 max-w-lg">
        A fully composed issue card using all sub-components — how they
      ...
      <Card variant="issue" interactive>
        ...
        <CardBody>
          Both nodes above 80% memory. Low-priority workloads moved to node-01.
        </CardBody>
        <CardFooter>
