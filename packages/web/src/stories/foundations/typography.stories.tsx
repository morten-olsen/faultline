...
const TypographyStory = (): React.ReactElement => (
  <div style={{ maxWidth: 640, color: '#e8e8e8' }}>
    <h2 style={{ fontSize: '1.5rem', fontWeight: 500, margin: '0 0 0.5rem', letterSpacing: '-0.02em' }}>Typography</h2>
    <p style={{ color: '#a3a3a3', fontSize: '0.875rem', lineHeight: 1.8, margin: '0 0 3rem', maxWidth: 520 }}>
      The way Faultline speaks matters as much as what it says. The typesetting carries clarity and quiet confidence —
      like a message from someone who has things under control.
    </p>

    {/* ── Two voices ── */}
    <h3 style={{ color: '#e8e8e8', fontSize: '1.125rem', fontWeight: 500, margin: '0 0 0.75rem' }}>Two voices</h3>
    <p style={{ color: '#a3a3a3', fontSize: '0.8125rem', lineHeight: 1.8, margin: '0 0 1.25rem', maxWidth: 520 }}>
      <strong style={{ color: '#e8e8e8' }}>Geist</strong> is the interface voice — clean, geometric, built for screens.
      How the platform speaks to you. Crisp at small sizes, expressive at large ones.{' '}
      <strong style={{ color: '#e8e8e8' }}>Geist Mono</strong> is the machine voice — for data that comes from the
      system. Node names, IPs, timestamps. The shift to monospace is a signal: "this is a specific thing you can look
      up."
    </p>
    ...
    <VoiceExample label="The platform speaking to you">
      ...
      >
        Noticed memory pressure on two nodes — rebalanced a few workloads to free up space. Everything else is
        unaffected.
      </p>
    </VoiceExample>
    ...
    {/* ── The scale ── */}
    <h3 style={{ color: '#e8e8e8', fontSize: '1.125rem', fontWeight: 500, margin: '0 0 0.75rem' }}>The scale</h3>
    <p style={{ color: '#a3a3a3', fontSize: '0.8125rem', lineHeight: 1.8, margin: '0 0 2.5rem', maxWidth: 520 }}>
      Tighter than a typical dashboard — a 14px base keeps the app feeling modern and compact. Each size has a clear
      purpose. The hierarchy communicates through scale, weight, and color together.
    </p>
    ...
    {/* ── Weight ── */}
    <h3 style={{ color: '#e8e8e8', fontSize: '1.125rem', fontWeight: 500, margin: '0 0 0.75rem' }}>Weight as tone</h3>
    <p style={{ color: '#a3a3a3', fontSize: '0.8125rem', lineHeight: 1.8, margin: '0 0 1.5rem', maxWidth: 520 }}>
      Weight carries emotional tone, not just hierarchy. Regular feels conversational. Medium adds emphasis. We keep it
      light — on dark backgrounds, heavy weights feel stressed, the opposite of calm. We never go above medium (500).
    </p>
    ...
    <div style={{ display: 'flex', gap: '3rem' }}>
      {(
        ...
        <div key={weight}>
          ...
          <div style={{ fontSize: '0.75rem', color: '#5a5a5a', fontFamily: '"Geist Mono Variable", monospace' }}>
            {label}
          </div>
        </div>
      ))}
    ...
    {/* ── Monospace ── */}
    <h3 style={{ color: '#e8e8e8', fontSize: '1.125rem', fontWeight: 500, margin: '0 0 0.75rem' }}>Monospace</h3>
    <p style={{ color: '#a3a3a3', fontSize: '0.8125rem', lineHeight: 1.8, margin: '0 0 2rem', maxWidth: 520 }}>
      Geist Mono is the machine voice. It surfaces when the interface shows something from the system — a node name, an
      IP, a timestamp, a command. The shift to monospace is a subtle signal: "this is a specific thing you can look up."
      It also appears in timestamps throughout the UI to give them a distinct visual rhythm.
    </p>
