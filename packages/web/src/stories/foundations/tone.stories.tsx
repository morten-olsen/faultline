...
import { Hand, CircleCheck, AlertTriangle, XCircle } from 'lucide-react';
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 10 }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
            ...
            <span
              style={{ fontSize: '0.6875rem', color: '#f87171', textTransform: 'uppercase', letterSpacing: '0.04em' }}
            >
              {wrong.label}
            </span>
          </div>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
            ...
            <span
              style={{ fontSize: '0.6875rem', color: '#4ade80', textTransform: 'uppercase', letterSpacing: '0.04em' }}
            >
              {right.label}
            </span>
          </div>
  ...
  <div style={{ maxWidth: 640, margin: '0 auto', color: '#e8e8e8' }}>
    <motion.div {...fadeUp}>
      ...
      <p style={{ color: '#a3a3a3', fontSize: '0.875rem', lineHeight: 1.7, marginBottom: 8, maxWidth: 520 }}>
        Faultline is a colleague, not a control panel. The way it communicates is as important as what it communicates.
        Every message should feel like it came from a calm, capable person — not a log parser or a monitoring dashboard.
      </p>
      <p style={{ color: '#5a5a5a', fontSize: '0.8125rem', lineHeight: 1.6, marginBottom: 40 }}>
        The same event can be described in a way that creates anxiety or in a way that creates confidence. We always
        choose confidence.
      </p>
    </motion.div>
    ...
    <Compare
      ...
      wrong={{
        label: 'Typical',
        text: 'No active alerts. 0 warnings. 0 critical.',
        icon: XCircle,
        iconColor: '#5a5a5a',
      }}
    ...
    <Compare
      ...
      wrong={{
        label: 'Typical',
        text: 'WARNING: Memory utilization on node-02 exceeded threshold (84% > 80%). Auto-remediation initiated.',
      }}
      right={{
        label: 'Faultline',
        text: 'Memory pressure on node-02 — moved a few workloads to free up space. Watching it settle.',
      }}
    ...
    <Compare
      ...
      wrong={{
        label: 'Typical',
        text: 'ACTION REQUIRED: Memory remediation failed. Manual intervention needed. Click here to review.',
      }}
      right={{
        label: 'Faultline',
        text: 'Approve evicting home-assistant? Your smart home would be offline for about 3 minutes, then resume automatically.',
        icon: Hand,
        iconColor: '#fbbf24',
      }}
    ...
    <Compare
      ...
      wrong={{
        label: 'Typical',
        text: 'ALERT: Previous remediation ineffective. Memory utilization has re-exceeded threshold. Escalating.',
      }}
      right={{
        label: 'Faultline',
        text: "Memory climbed back above 80%. The first approach didn't hold — trying something different.",
      }}
    ...
    <Compare
      ...
      wrong={{
        label: 'Typical',
        text: 'RESOLVED: Alert cleared. Memory utilization returned to nominal levels. Alert duration: 50m.',
      }}
    ...
    <motion.div {...stagger(0, 0.1)}>
      ...
      <p style={{ color: '#a3a3a3', fontSize: '0.8125rem', lineHeight: 1.6, marginBottom: 16, maxWidth: 480 }}>
        When the system talks to you, it uses Geist — warm, proportional, conversational. When it shows you data from
        the infrastructure, it shifts to Geist Mono. This isn't just styling — it's a signal. Proportional means "I'm
        talking to you." Mono means "this is a specific thing you can look up."
      </p>
    </motion.div>
    ...
    <VoiceDemo label="The colleague" index={0}>
      ...
      >
        Memory has been above 80% for over an hour despite two rebalancing attempts. The most effective option is to
        evict home-assistant temporarily — your smart home would be offline for about 3 minutes, then resume
        automatically.
      </p>
    </VoiceDemo>
    ...
    <VoiceDemo label="Both together" index={2}>
      ...
      >
        ...
        <span style={{ fontFamily: '"Geist Mono Variable", monospace', color: '#a3a3a3' }}>node-02</span> dropped from{' '}
        <span style={{ fontFamily: '"Geist Mono Variable", monospace', color: '#a3a3a3' }}>84%</span> to{' '}
      ...
      {[
        {
          ...
          example: '"Memory pressure" not "memory utilization threshold exceeded."',
        },
        { rule: 'Active voice over passive.', example: '"Restarted the pod" not "the pod was restarted."' },
        {
          rule: 'Describe impact, not metrics.',
          example: '"Your smart home would be offline for 3 minutes" not "pod eviction with 30s grace period."',
        },
        {
          rule: 'Questions over commands.',
          example: '"Approve evicting home-assistant?" not "ACTION REQUIRED: evict home-assistant."',
        },
        {
          rule: 'Honesty over optimism.',
          example: '"The first approach didn\'t hold" not "remediation partially successful."',
        },
        { rule: 'Quiet over loud.', example: '"Resolved" not "SUCCESS: Alert cleared!"' },
        {
          rule: 'Present tense over past.',
          example: '"Watching memory settle" not "memory was observed to decrease."',
        },
