...
const countOrNull = (arr: string[] | null): number | null => (arr === null ? null : arr.length);
        ...
        <motion.div {...fadeUp}>
          <div className="flex items-start gap-2.5 bg-white/3 rounded-xl px-4 py-3 mb-6">
            ...
            <span className="text-sm text-text-secondary leading-relaxed">
              Stage configs control what the agent can access at each stage of the issue lifecycle. Unconfigured stages
              are unrestricted — the agent can use all integrations. Configure a stage to limit access.
            </span>
          </div>
        </motion.div>
      )}
