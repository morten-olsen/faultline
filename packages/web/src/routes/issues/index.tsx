  ...
  return (
    <PageShell>
      ...
      <div className="pt-2 pb-12">
        {isLoading && <p className="text-sm text-text-muted py-8 text-center">Loading…</p>}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline justify-between gap-3">
                    ...
                    <span className="text-xs text-text-muted font-mono flex-shrink-0">{issue.priority}</span>
                  </div>
