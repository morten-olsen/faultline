...
const IndexComponent = (): React.ReactElement => {
    ...
    <div className="bg-bg min-h-screen font-sans text-text antialiased">
      <div className="max-w-lg mx-auto px-5">
        ...
        <div className="pt-8 pb-12">
          ...
          <p className="mt-2 text-text-muted text-sm">Autonomous infrastructure management</p>
          <div className="mt-6">
            <Button variant="secondary" icon={AlertTriangle} onClick={() => navigate({ to: '/issues' })}>
              Issues
            </Button>
          </div>
        </div>
